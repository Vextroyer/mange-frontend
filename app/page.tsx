    ...
    <main className=" flex flex-col-reverse lg:flex-row bg-[url('http://localhost:3000/images/fondoClaro.png')] dark:bg-transparent bg-cover bg-no-repeat bg-center">
      <div className=" w-full lg:w-1/2 flex items-center justify-center p-4 lg:h-screen flex-col sm:h-max dark:bg-black shadow-2xl overflow-hidden dark:border-zinc-800 bg-transparent">
        ...
        <ul className="flex justify-center mt-5 space-x-5">
          <li>
            <a className="text-gray-200 hover:text-blue-700 dark:hover:text-white dark:text-gray-400">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <li>
            <a className="text-gray-200 hover:text-black dark:hover:text-white dark:text-gray-400">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <li>
            <a className="text-gray-200 hover:text-red-700 dark:hover:text-white dark:text-gray-400">
              <svg
                aria-hidden="true"
                viewBox="0 0 24 24"
                fill="currentColor"
